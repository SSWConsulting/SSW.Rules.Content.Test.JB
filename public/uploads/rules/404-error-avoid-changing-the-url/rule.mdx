...
lastUpdated: 2026-05-08T13:00:00.529Z
lastUpdatedBy: 'Jber '
lastUpdatedByEmail: jber4409@uni.sydney.edu.au
isArchived: false
archivedreason: null
---

When I request a exist, you will get an error message. You should make sure that the URL in the browser doesn't change. This way, it's easy for the user to correct.
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="URL changes" src="https://assets.tina.io/862737f9-1180-4e5e-8074-2d7188c4124b/rules/404-error-avoid-changing-the-url/path-to-tina-folder.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Customized 404 error page without change the URL" src="/uploads/rules/404-error-avoid-changing-the-url/404-good_1710232021928.jpg" />
