---
type: rule
title: Do you know the 4 steps to completing a PBI?
...
lastUpdated: 2026-04-17T09:49:39.982Z
lastUpdatedBy: 'Jber '
lastUpdatedByEmail: jber4409@uni.sydney.edu.au
archivedreason: null
---

Test - Josh Make some change here A PBI (Product Backlog Item) is a term commonly used in Agile project management and software development to represent a unit of work. It refers to an item in the Product Backlog, which is a prioritized list of features, enhancements, or fixes to be addressed in a project.

<imageEmbed alt="Image" size="small" showBorder={false} figurePrefix="none" figure="" src="https://assets.tina.io/dbbf07ed-e61b-4212-9b1a-29d53cbe0e89/rules/3-steps-to-a-pbi/btc.svg" />
